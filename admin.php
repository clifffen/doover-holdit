...
<p>
<strong><a href="javascript:void(0);" onmouseup="if(confirm('Are you sure do you want to run this script? It can take a few minutes depending on the amount of photos and speed of your server.')){window.location='<?php echo $gallery_url;?>/admin-regenerate-thumbnails';}">Regenerate thumbnails</a></strong> <br />
Use this feature when you want to generate thumbnails again based on the saved source file of each image. Each image is stored on server in 3 files (file_source.jpg, file_thumbnail.jpg, file.jpg).<br />
